...
public class Secp256k1KeyManagerTest {
    ...
    public void recoverFromMnemonic() {
        String mnemonic = "source glance produce team hub curious resist grunt lawsuit praise mad alien ceiling mango clown notable future cable cover project wool rough foster reflect";
        KeyManager km = KeyManagerFactory.createKeyManger(AlgoEnum.SECP256K1);
        km.recover(mnemonic);

        KeyInfo keyInfo = km.getCurrentKeyInfo();
        assertEquals("iaa1u0dywjq65lvekrae605hdx9mqzea2q8k0094fq", keyInfo.getAddress());
        assertEquals("e9f0b392f6fceab5097a3857d4708e0f311dd1bc18f8ffddd67cc17bceb880ad", keyInfo.getPrivKey().toString(16));
    }

    @Test
    public void recoverFromPrivateKey() {
        BigInteger privKey = new BigInteger("e9f0b392f6fceab5097a3857d4708e0f311dd1bc18f8ffddd67cc17bceb880ad", 16);
        KeyManager km = KeyManagerFactory.createKeyManger(AlgoEnum.SECP256K1);
        km.recover(privKey);
