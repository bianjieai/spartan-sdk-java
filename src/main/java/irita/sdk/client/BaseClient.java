...
public class BaseClient {
    ...
    public Account queryAccount(String address) {
        ...
        proto.ethermint.types.v1.Account.EthAccount ethAccount = null;
        try {
            ethAccount = resp.getAccount().unpack(proto.ethermint.types.v1.Account.EthAccount.class);
        } catch (InvalidProtocolBufferException e) {
            throw new IritaSDKException("account:\t" + address + "is not exist", e);
        }
        baseAccount = ethAccount.getBaseAccount();
